...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (testCheck(currentPlayer)) {
			...
			throw new ChessException("You can't pull yourself in check position!");
		}
	...
	private void validateSourcePosition(Position position) {
		...
		// A condição thereIsAPiece deve ser tratada primeiro!
	...
	private Piece makeMove(Position source, Position target) {
		...
		// Coloca P no target, substituindo a peça ou null
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// Enpassant
		if (p instanceof Pawn) {
			if (target.getColumn() != source.getColumn() && capturedPiece == enPassant) {
	...
	// Initial Setup é a unica que chama essa função para alocar peça com letra e
	// número.
